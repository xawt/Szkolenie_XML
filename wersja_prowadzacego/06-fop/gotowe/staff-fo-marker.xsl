...
<xsl:stylesheet version="1.0"
			...
			<fo:page-sequence master-reference="A4">
				<fo:static-content flow-name="xsl-region-before">
					<fo:block>
						...
						<fo:inline color="red"><fo:retrieve-marker retrieve-class-name="dep-name" retrieve-position="first-starting-within-page"/></fo:inline>
						<xsl:text>.</xsl:text>
					</fo:block>
					<fo:block margin-top="6pt" text-align="center">page <fo:page-number/></fo:block>
				</fo:static-content>
	...
	<xsl:template match="department">
		<fo:block space-before.minimum="12pt" space-after.minimum="6pt">
			<fo:marker marker-class-name="dep-name">
